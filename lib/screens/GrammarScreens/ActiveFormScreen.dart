...
class _ActiveScreenState extends State<ActiveScreen> {
  ...
  void submitAnswer() {
    setState(() {
      ...
      String correctAnswer = questions[currentQuestionIndex]['Active'];
              ...
              child: Column(
                ...
                children: [
                  ...
                  isLoading // Display loading circle if isLoading is true
                    ...
                    child: Text(
                      questions[currentQuestionIndex]['Passive'],
                      style: TextStyle(
